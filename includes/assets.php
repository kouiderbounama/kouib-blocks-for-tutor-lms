...
/**
 * Register translation sources for the block editor scripts (kouib/* blocks).
 *
...
/**
 * Supplies the Arabic editor translations for the kouib/* block scripts through
 ...
 */
function kouib_pre_load_script_translations( $translations, $file, $slug, $domain ) {
	if ( 'kouib-blocks-for-tutor-lms' !== $domain || 'ar' !== get_locale() ) {
		return $translations;
	}

	$blocks = array(
		'kouib-courses-filter-editor-script'      => 'courses-filter',
		'kouib-courses-carousel-editor-script'    => 'courses-carousel',
		'kouib-courses-categories-editor-script'  => 'courses-categories',
		'kouib-courses-search-editor-script'      => 'courses-search',
		'kouib-courses-stats-editor-script'       => 'courses-stats',
	);
...
add_filter(
	...
	'kouib_pre_load_script_translations',
	10,
	4
);
