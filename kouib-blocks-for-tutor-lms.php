...
require_once __DIR__ . '/includes/editor-i18n.php';
 ...
 * 1. Translations
 * ========================================================================== */
// WordPress 4.6+ auto-loads translations from translate.wordpress.org for
// plugins hosted on the directory — no load_plugin_textdomain() needed.
